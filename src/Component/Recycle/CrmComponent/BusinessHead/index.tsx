...
const DashboardBusinessHead = (props: any) => {
  ...
  const { params } = route;
  const siteName = "All";
  const [city, setCity] = useState(siteName);
  ...
  // *************************************Use Effect With City Condition********************
  useEffect(() => {
    setCheck(true);
    setCheck1(true);
    setCheck2(true);
  ...
  const historyApi = async (date3, date4, date2) => {
    ...
    // setLoading(true);
    const result = await ApiClient.createApiClient().recyclecrmbusinessheadhistory(payload);
    // @ts-ignore
  ...
  const exportHistoryDataToExcelDownload = (downloadHistoryData) => {
    ...
    RNFS.writeFile(path + '/recycle_crm_business_history_data_' + new Date().getTime() + '.xlsx', wbout, 'ascii').then(() => {
      {
        Platform.OS === 'android' ?
  ...
  const collectionTrendApi = async (date, date1, date2) => {
    ...
    // setLoading(true);
    const result = await ApiClient.createApiClient().recyclecrmbusinessheadcollectiontrendgraph(payload);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const processedTrendApi = async (date, date1, date2) => {
    ...
    // const params ={start:previousDay,end:time1,siteName:city};
    // setLoading(true);
    const result = await ApiClient.createApiClient().recyclecrmbusinessheadprocesstrendgraph(payload);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const segregatedTrendApi = async (date, date1, date2) => {
    ...
    // const params ={start:previousDay,end:time1,siteName:city};
    // setLoading(true);
    const result = await ApiClient.createApiClient().recyclecrmbusinessheadsegregatedtrendgraph(payload);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const wasteSummaryApi = async (date, date1, date2) => {
    ...
    payload.append("end", time1);
    payload.append("siteName", city);
    const result = await ApiClient.createApiClient().recyclecrmbusinessheadmaterialsummary(payload);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
  ...
  const processedSummaryApi = async (date, date1, date2) => {
    ...
    payload.append("end", time1);
    payload.append("siteName", city);
    const result = await ApiClient.createApiClient().recyclecrmbusinessheadprocessedsummary(payload);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
  ...
  const productSummaryApi = async (date, date1, date2) => {
    ...
    payload.append("end", time1);
    payload.append("siteName", city);
    const result = await ApiClient.createApiClient().recyclecrmbusinessheadproductionsummary(payload);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
  ...
  const collectedWasteLeftMenuApi = async (date5, date6, date2) => {
    ...
    payload.append("end", time1);
    payload.append("siteName", city);
    const result = await ApiClient.createApiClient().recyclecrmBusinessHeadnavbarCollection(payload);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const segregationWasteLeftMenuApi = async (date7, date8, date2) => {
    ...
    const result = await ApiClient.createApiClient().recyclecrmBusinessHeadnavbarsegregated(payload);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const processedWasteLeftMenuApi = async (date9, date10, date2) => {
    ...
    const result = await ApiClient.createApiClient().recyclecrmBusinessiteHeadnavbarprocessed(payload);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const exportCollectionDataToExcelDownload = (downloadCollectionData) => {
    ...
    // Write generated excel to Storage
    const path = Platform.OS === 'ios' ? RNFS.DocumentDirectoryPath : RNFS.DownloadDirectoryPath;
    RNFS.writeFile(path + '/recycle_crm_business_head_collection_data_' + new Date().getTime() + '.xlsx', wbout, 'ascii').then(() => {
      {
        Platform.OS === 'android' ?
          ToastAndroid.showWithGravityAndOffset("Excel File Is Downloaded Successfully", ToastAndroid.SHORT, ToastAndroid.BOTTOM, 25, 50) :
          Alert.alert("Excel File Is Downloaded Successfully");
  ...
  const exportCollectionDataToExcelSharing = (sharingCollectionData) => {
    ...
    // Write generated excel to Storage
    const path = Platform.OS === 'ios' ? RNFS.DocumentDirectoryPath : RNFS.DownloadDirectoryPath;
    RNFS.writeFile(path + '/recycle_crm_business_head_collection_data_sharing.xlsx', wbout, 'ascii').then(() => {
    }).catch((e) => {
      console.log('Error', e);
    });
  ...
  const shareCollectionExcel = async () => {
    const path = Platform.OS === 'ios' ? RNFS.DocumentDirectoryPath : RNFS.DownloadDirectoryPath;
    const dir = path + '/recycle_crm_business_head_collection_data_sharing.xlsx';
    const options = {
  ...
  const exportSegregationDataToExcelDownload = (downloadSegregationData) => {
    ...
    // Write generated excel to Storage
    const path = Platform.OS === 'ios' ? RNFS.DocumentDirectoryPath : RNFS.DownloadDirectoryPath;
    RNFS.writeFile(path + '/recycle_crm_business_head_segregation_data_' + new Date().getTime() + '.xlsx', wbout, 'ascii').then(() => {
      {
        Platform.OS === 'android' ?
          ToastAndroid.showWithGravityAndOffset("Excel File Is Downloaded Successfully", ToastAndroid.SHORT, ToastAndroid.BOTTOM, 25, 50) :
          Alert.alert("Excel File Is Downloaded Successfully");
  ...
  const exportSegregationDataToExcelSharing = (sharingSegregationData) => {
    ...
    // Write generated excel to Storage
    const path = Platform.OS === 'ios' ? RNFS.DocumentDirectoryPath : RNFS.DownloadDirectoryPath;
    RNFS.writeFile(path + '/recycle_crm_business_head_segregation_data_sharing.xlsx', wbout, 'ascii').then(() => {
    }).catch((e) => {
      console.log('Error', e);
    });
  ...
  const shareSegregationExcel = async () => {
    const path = Platform.OS === 'ios' ? RNFS.DocumentDirectoryPath : RNFS.DownloadDirectoryPath;
    const dir = path + '/recycle_crm_business_head_segregation_data_sharing.xlsx';
    const options = {
      url: Platform.OS === 'android' ? `file://${dir}` : dir,
      message: 'Sharing File',// By omitting the message, whatsapp shows the image
    };
  ...
  const exportProcessedDataToExcelDownload = (downloadProcessedData) => {
    ...
    // Write generated excel to Storage
    const path = Platform.OS === 'ios' ? RNFS.DocumentDirectoryPath : RNFS.DownloadDirectoryPath;
    RNFS.writeFile(path + '/recycle_crm_business_head_processed_data_' + new Date().getTime() + '.xlsx', wbout, 'ascii').then(() => {
      {
        Platform.OS === 'android' ?
          ToastAndroid.showWithGravityAndOffset("Excel File Is Downloaded Successfully", ToastAndroid.SHORT, ToastAndroid.BOTTOM, 25, 50) :
          Alert.alert("Excel File Is Downloaded Successfully");
  ...
  const exportProcessedDataToExcelSharing = (sharingProcessedData) => {
    ...
    // Write generated excel to Storage
    const path = Platform.OS === 'ios' ? RNFS.DocumentDirectoryPath : RNFS.DownloadDirectoryPath;
    RNFS.writeFile(path + '/recycle_crm_business_head_processed_data_sharing.xlsx', wbout, 'ascii').then(() => {
    }).catch((e) => {
      console.log('Error', e);
    });
    shareProcessedExcel();
  ...
  const shareProcessedExcel = async () => {
    const path = Platform.OS === 'ios' ? RNFS.DocumentDirectoryPath : RNFS.DownloadDirectoryPath;
    const dir = path + '/recycle_crm_business_head_processed_data_sharing.xlsx';
    const options = {
      url: Platform.OS === 'android' ? `file://${dir}` : dir,
      message: 'Sharing File',// By omitting the message, whatsapp shows the image
    };
