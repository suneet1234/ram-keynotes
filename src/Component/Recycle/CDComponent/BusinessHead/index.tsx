...
const DashboardBusinessHead = (props: any) => {
  ...
  // @ts-ignore
  const maxdata2 = Math.max(...productTrend.map((o) => o.product));
  // *******************************Use Effect***********************************
  ...
  const wasteSummaryApi = async (date, date1, date2) => {
    ...
    const result =
      await ApiClient.createApiClient().recyclecdbusinessheadwastesummary(
        payload
      );
    // @ts-ignore
  ...
  const collectionTrendApi = async (date, date1, date2) => {
    ...
    const result =
      await ApiClient.createApiClient().recyclecdbusinessheadcollectiongrpah(
        payload
      );
    // @ts-ignore
    if (result.status && result.data.status === true) {
  ...
  const productTrendApi = async (date, date1, date2) => {
    ...
    const result =
      await ApiClient.createApiClient().recycleCDBusinessHeadProductTrend(
        payload
      );
    // @ts-ignore
    if (result.status && result.data.status === true) {
  ...
  const processedTrendApi = async (date, date1, date2) => {
    ...
    const result =
      await ApiClient.createApiClient().recyclecdbusinessheadprocessedgrpah(
        payload
      );
    // @ts-ignore
    if (result.status && result.data.status === true) {
  ...
  const productSummaryApi = async (date, date1, date2) => {
    ...
    const result =
      await ApiClient.createApiClient().recycleCDBusinessHeadProductSummary(
        payload
      );
    // @ts-ignore
    if (result.status && result.data.status === true) {
  ...
  const collectedWasteLeftMenuApi = async (date5, date6, date2) => {
    ...
    const result =
      await ApiClient.createApiClient().recyclecdbusinessheadnavbarcollectedwaste(
        payload
      );
    // @ts-ignore
    if (result.status && result.data.status === true) {
      ...
      if ((result?.data?.data ?? []).length > 0) {
        ...
        console.log("collectedddddd", collectedLeftMenuValue);
      }
    } else {
  ...
  const processedWasteLeftMenuApi = async (date9, date10, date2) => {
    ...
    const result =
      await ApiClient.createApiClient().recyclecdbusinessheadnavbarprocessed(
        payload
      );
    // @ts-ignore
    if (result.status && result.data.status === true) {
  ...
  const productWasteLeftMenuApi = async (date9, date10, date2) => {
    ...
    const result =
      await ApiClient.createApiClient().recycleCDBusinessHeadProduct(payload);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const processedSummaryApi = async (date, date1, date2) => {
    ...
    const result =
      await ApiClient.createApiClient().recyclecdbusinessheadprocessedsummary(
        payload
      );
    // @ts-ignore
    if (result.status && result.data.status === true) {
  ...
  const historyApi = async (date3, date4, date2) => {
    ...
    const result =
      await ApiClient.createApiClient().recyclecdbusinessheadhistory(payload);
    // @ts-ignore
    if (result.status && result.data.status === true) {
      // @ts-ignore
      if ((result?.data?.data ?? []).length > 0) {
  ...
  const exportHistoryDataToExcelDownload = (downloadHistoryData) => {
    ...
    RNFS.writeFile(
      path +
      "/recycle_cd_business_head_history_data_" +
      new Date().getTime() +
      ".xlsx",
      wbout,
      "ascii"
  ...
  const exportCollectionDataToExcelDownload = (downloadCollectionData) => {
    ...
    RNFS.writeFile(
      path +
      "/recycle_cd_business_head_collection_data_" +
      new Date().getTime() +
      ".xlsx",
      wbout,
      "ascii"
  ...
  const exportCollectionDataToExcelSharing = (sharingCollectionData) => {
    ...
    const path =
      Platform.OS === "ios"
        ...
        : RNFS.DownloadDirectoryPath;
    RNFS.writeFile(
      path + "/recycle_cd_business_head_collection_data_sharing.xlsx",
      wbout,
      "ascii"
    )
      .then(() => { })
  ...
  const shareCollectionExcel = async () => {
    const path =
      Platform.OS === "ios"
        ? RNFS.DocumentDirectoryPath
        : RNFS.DownloadDirectoryPath;
    const dir = path + "/recycle_cd_business_head_collection_data_sharing.xlsx";
    const options = {
  ...
  const exportProcessedDataToExcelDownload = (downloadProcessedData) => {
    ...
    RNFS.writeFile(
      path +
      "/recycle_cd_business_head_processed_data_" +
      new Date().getTime() +
      ".xlsx",
      wbout,
      "ascii"
  ...
  const exportProcessedDataToExcelSharing = (sharingProcessedData) => {
    ...
    const path =
      Platform.OS === "ios"
        ...
        : RNFS.DownloadDirectoryPath;
    RNFS.writeFile(
      path + "/recycle_cd_business_head_processed_data_sharing.xlsx",
      wbout,
      "ascii"
    )
      .then(() => { })
  ...
  const shareProcessedExcel = async () => {
    const path =
      Platform.OS === "ios"
        ? RNFS.DocumentDirectoryPath
        : RNFS.DownloadDirectoryPath;
    const dir = path + "/recycle_cd_business_head_processed_data_sharing.xlsx";
    const options = {
      url: Platform.OS === "android" ? `file://${dir}` : dir,
      message: "Sharing File", // By omitting the message, whatsapp shows the image
    };
  ...
  const exportProductDataToExcelDownload = (downloadProductData) => {
    ...
    RNFS.writeFile(
      path +
      "/recycle_cd_business_head_product_data_" +
      new Date().getTime() +
      ".xlsx",
      wbout,
      "ascii"
  ...
  const exportProductDataToExcelSharing = (sharingProductData) => {
    ...
    const path =
      Platform.OS === "ios"
        ...
        : RNFS.DownloadDirectoryPath;
    RNFS.writeFile(
      path + "/recycle_cd_business_head_product_data_sharing.xlsx",
      wbout,
      "ascii"
    )
      .then(() => { })
  ...
  const shareProductExcel = async () => {
    const path =
      Platform.OS === "ios"
        ? RNFS.DocumentDirectoryPath
        : RNFS.DownloadDirectoryPath;
    const dir = path + "/recycle_cd_business_head_product_data_sharing.xlsx";
    const options = {
      url: Platform.OS === "android" ? `file://${dir}` : dir,
      message: "Sharing File", // By omitting the message, whatsapp shows the image
    };
  ...
  // ***********************Accordion Content In Collected Product Processed Methods******************
    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        <View style={styles.ThirdContainer}>
          <View style={styles.ThirdcardContainer}>
            ...
            <View style={styles.wasteCollectedProcessedBoxView}>
              ...
              <View
                style={[
                  styles.wasteCollectedProcessedBoxView1,
                  { marginLeft: 20 },
                ]}
              >
                <Text style={styles.wasteCollectedProcessedBoxText}>
        ...
        <View style={styles.ThirdContainer}>
          <View style={styles.ThirdcardContainer}>
            <View style={styles.thirdcardFirstOneView}>
              <Text style={[styles.collectionTrendtext12, { top: 10 }]}>
                Processed Summary
              </Text>
            </View>
            {rdf.length > 0 ? (
              <View style={styles.newdata}>
                <SwiperFlatList
                  ...
                  showPagination={true}
                  paginationStyle={{ top: Platform.OS === 'ios'?height / 6 :height / 6.5 }}
        ...
        <View style={[styles.ThirdContainer, { marginBottom: 50, top: 20 }]}>
          <View style={styles.ThirdcardContainer}>
            <View style={styles.thirdcardFirstOneView}>
              <Text style={[styles.collectionTrendtext12, { top: 10 }]}>
                Product Summary
